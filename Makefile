...
GCCPARAMS = -m32 -fno-use-cxa-atexit -nostdlib -fno-builtin -fno-rtti -fno-exceptions -fno-leading-underscore # tell the compiler that there is no OS or the glibc standard library to which it can link or use extra functionalities, exceptions, etc
ASPARAMS = --32
LDPARAMS = -melf_i386
