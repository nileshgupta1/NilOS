...
#ifndef __NILOS__DRIVERS__VGA_H
#define __NILOS__DRIVERS__VGA_H
...
namespace nilos
{
    namespace drivers
    {
        ...
        protected:
            ...
            hardwarecommunication::Port8Bit crtcIndexPort; // crtc: cathode ray tube controller
            ...
            // Sends initialization codes to the ports
